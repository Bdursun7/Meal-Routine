...
# xcodebuild test -project MealRoutine.xcodeproj -scheme MealRoutine -destination 'platform=iOS Simulator,name=iPhone 16,OS=18.0,arch=arm64' -only-testing:MealRoutineTests
set -euo pipefail
